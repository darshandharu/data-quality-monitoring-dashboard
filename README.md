...
![Streamlit Dashboard](screenshots/streamlit_live.png)

> The live dashboard queries the database in real time, auto-refreshes every 60 s,
> and shows all 6 KPIs side-by-side with interactive Plotly charts.

### Offline Charts (no database required)
Run `python scripts/generate_report_charts.py` to regenerate these from the raw CSV:
